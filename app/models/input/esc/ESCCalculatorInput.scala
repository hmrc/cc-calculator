...
case class ESCTaxYear(from: LocalDate,
                      until: LocalDate,
...
case class ESCPeriod(from: LocalDate,
                     until: LocalDate,
...
case class ESCTotalIncome(taxablePay: BigDecimal = BigDecimal(0.00),
...
case class ESCIncome(employmentIncome : Option[BigDecimal] = None,

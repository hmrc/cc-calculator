...
@Singleton
class TFCCalculatorController @Inject()(val messagesApi: MessagesApi, auditEvent: AuditEvents,
                                        calculator: TFCCalculator) extends BaseController with I18nSupport {
